...
//const baseDomain = 'https://ezheal.in/api';
...
export const baseDomainImage = 'http://localhost:1337'
//export const baseDomainImage = 'https://ezheal.in'
export const customHeaders = {
    Accept: 'application/json',
};

export const baseUrl = `${baseDomain}`;
export const baseUrlImage = `${baseDomainImage}`
